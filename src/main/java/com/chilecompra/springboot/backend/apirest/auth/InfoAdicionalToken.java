...
import com.chilecompra.springboot.backend.apirest.models.services.IUsuarioService;
...
public class InfoAdicionalToken implements TokenEnhancer{ //le agregamos mas info a nuestro token de acceso
	...
	public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
		...
		info.put("nombre", usuario.getNombre()); //estamos pasando datos del usuario autenticado
